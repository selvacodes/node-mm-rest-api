...
function MMRestApi(config = {}) {
  ...
  var token = bearerToken ? Promise.resolve(bearerToken) : undefined;
  ...
  authSites.actions = authSiteActions;
  authSites.scripts = authSiteScripts;
  authCampaigns.elements = authElements;
  authCampaigns.variants = authVariants;
  authCampaigns.scripts = authCampaignScripts;
  authCampaigns.actions = authCampaignActions;
